	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-comments">
			...
			<dd style="display:block">
				<ul>
					<li class="current"><a href="{{url('manager/msg')}}" title="通知列表">通知列表</a></li>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 通知列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
				...
				<table class="table table-border table-bordered table-bg table-sort">
					...
					<tbody>
						<tr class="text-c">
							...
							<td>紧急公告紧急公告紧急公告紧急公告</td>
							<td>是</td>
							<td>1000</td>
							<td>2017-11-11 10:22</td>
