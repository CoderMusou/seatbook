	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd style="display:block">
				<ul>
					<li class="current"><a href="{{url('manager/book')}}" title="当前预约列表">当前预约列表</a></li>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>  预约列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<tr class="text-c">
							...
							<td>张三</td>
							<td class="text-c">图书馆二层402-402</td>
							<td>2017-11-11 08:11:42~2017-11-11 20:11:42</td>
...
<!--_footer 作为公共模版分离出去-->
<script type="text/javascript" src="{{asset('admin/lib/jquery/1.9.1/jquery.min.j')}}s"></script>
